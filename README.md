...
- data_exploration.py: This script automates the loading of iDRAC energy logs and LiteLLM usage data to compute carbon intensity. 
- Per-Model Energy & CO₂ Estimation: A specialized module (or logic within the main script) that applies weighted attribution to disaggregate energy use by specific LLMs. 
