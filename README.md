...
- **`Report_environmental_impact_assessment.pdf`**: A detailed description of all the phases of the LCA (Life-Cycle Assessment), including methodology, tool results, and the full bibliography.
